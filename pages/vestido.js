...
export default function Vestido() {
  ...
  return (
    <>
      <Head>
        <title>Catálogo de Vestidos - Dana Jalecos</title>
        <meta name="description" content="Catálogo completo de vestidos da Dana Jalecos" />
      ...
      <div style={{ 
        ...
        <header style={{ 
          ...
          <p style={{ 
            ...
            Total de produtos: {vestidoData.metadata?.totalProdutos || 0}
          </p>
        </header>

        <main>
          {vestidoData.masculino && renderProdutos(vestidoData.masculino, 'Masculinos')}
          {vestidoData.feminino && renderProdutos(vestidoData.feminino, 'Femininos')}
          {vestidoData.unissex && renderProdutos(vestidoData.unissex, 'Unissex')}
        </main>
      </div>
    </>
  );
