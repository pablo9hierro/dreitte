...
export default function Cracha() {
  ...
  return (
    <>
      <Head>
        <title>Catálogo de Crachás - Dana Jalecos</title>
        <meta name="description" content="Catálogo completo de crachás da Dana Jalecos" />
      ...
      <div style={{ 
        ...
        <header style={{ 
          ...
          <p style={{ 
            ...
            Total de produtos: {crachaData.metadata?.totalProdutos || 0}
          </p>
        </header>

        <main>
          {crachaData.masculino && renderProdutos(crachaData.masculino, 'Masculinos')}
          {crachaData.feminino && renderProdutos(crachaData.feminino, 'Femininos')}
          {crachaData.unissex && renderProdutos(crachaData.unissex, 'Unissex')}
        </main>
      </div>
    </>
  );
